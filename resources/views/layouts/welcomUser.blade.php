...
<body>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    ...
                    <img class="w-100" src="{{ asset('asset1/img/carrousel1.jpg') }}" alt="Image">

                    <div class="carousel-caption d-flex align-items-center mb-3">

                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                                    <h6 class="text-white text-uppercase mb-3 animated slideInDown">// Yobalama //</h6>
                                    <h1 class="display-3 text-white mb-4 pb-3 animated slideInDown">PAYEZ À PETIT PRIX.
                                    </h1>
                                </div>
                                <div class="col-lg-5 d-none d-lg-flex animated zoomIn">
                                    <img class="img-fluid" src="{{ asset('asset1/img/carousel-1.png') }}"
                                        alt="">
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <form class="form" action="{{route('Location.store') }}" method="POST">
                                        ...
                                        <div class="row mb-2 mt-3">
                                            <div class="col-sm-12 col-md-8 mb-lg-0 ">
                                                ...
                                                <label for="form" class="text-dark">lieu de depart</label>
                                                <input type="text" id="address1" class="form-control"
                                                    name="lieu_depart" value="{{ old('lieu_depart') }}">
                                            ...
                                            <div class="col-sm-12 col-md-12 mb-lg-0 col-lg-4 ">
                                                <label for="" class="text-dark from-control">Lieu d'arriver
                                                    différent</label>
                                                <input type="text" id="address2" class="form-control"
                                                    name="lieu_arrivee" value="{{ old('lieu_arrivee') }}">
                                            </div>
                                            <div class="text-danger">
                                                @error('lieu_arrivee')
                                                    {{ $message }}
                                                ...
                                                <div class="row  mt-3">
                                                    <div class="col-lg-6 mb-3 mb-lg-0">
                                                        <div class="d-flex align-items-start">
                                                            <div class="col-md-8">
                                                                <label for="" class="text-dark">Date de
                                                                    départ</label>
                                                                <input type="date" class="form-control"
                                                                    id="departureDate" name="date_debut"
                                                                    value="{{ \Carbon\Carbon::now()->format('Y-m-') . (new \Carbon\Carbon('first day of this month'))->format('d') }}">
                                                                    <div class="text-danger">
                                                                        @error('date_debut')
                                                                            {{ $message }}
                                                                        @enderror
                                                    ...
                                                    <div class="col-sm-12 mb-lg-0 col-lg-4">
                                                        <div class="d-flex align-items-start">
                                                            <div class="col-md-8">
                                                                <label for="" class="text-dark">Date
                                                                    d'arriver</label>
                                                                <input type="date" class="form-control"
                                                                    name="date_fin" value="" id="arrivalDate"
                                                                    readonly>
                                                            ...
                                                            <div class="col-sm-6 col-md-2  mt-3 col-lg-2 offset-2">
                                                                ...
                                                                <button type="button" onclick="calculateDistance() "
                                                                    ...
                                                                    data-bs-target="#exampleModaldist">kilometrage</button>
                                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <label class="control control--checkbox mt-3"
                                                    ...
                                                    <span class="caption text-dark mt-3"
                                                        style="display: inline-block; text-decoration: underline; font-size: smaller; color:#D8132;">Enregistrer
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('asset1/img/a.jpg') }}" alt="Image">
                    <div class="carousel-caption d-flex align-items-center mb-3">
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-6 col-lg-7 text-center text-lg-start">
                                    <h6 class="text-white text-uppercase mb-3 animated slideInDown">//Yobalama//</h6>
                                    <h1 class="display-3 text-white mb-4 pb-3 animated slideInDown">PAYEZ À PETIT PRIX.
                                    </h1>
                                ...
                                <div class="col-lg-5 d-none d-lg-flex animated zoomIn">
                                    <img class="img-fluid" src="{{ asset('asset1/img/carousel-2.png') }}"
                                        alt="">
                                </div>
                            </div>
                            <div class="row">
    ...
    <div class="modal fade" id="exampleModaldist" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Bon voyage</h1>
