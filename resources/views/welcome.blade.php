                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                                    ...
                                    <h1 class="display-3 text-white mb-4 pb-3 animated slideInDown">PAYEZ À PETIT PRIX.</h1>
                                </div>
                                <div class="col-lg-5 d-none d-lg-flex animated zoomIn">
                                    <img class="img-fluid" src="{{asset('asset1/img/carousel-1.png')}}" alt="">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                    ...
                    <div class="carousel-caption d-flex align-items-center mb-3">
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                ...
                                <div class="col-lg-5 d-none d-lg-flex animated zoomIn">
                                    <img class="img-fluid" src="{{asset('asset1/img/carousel-2.png')}}" alt="">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
